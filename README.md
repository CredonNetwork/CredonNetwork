...
A. Two things, 1. I wish I had setup ELSE branches for my IF ELSE statements in case my code wasn't perfect. 2. I wish that I had used namespace standard, due to it being simpler to read. However, I was trying to practice without it to avoid 'potential name collisions'.
